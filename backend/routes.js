...
const { createPersonDevice, deletePersonDevice, getAllPersonDevices, getPersonsByDeviceId, getDevicesByPersonId, getPersonDeviceById } = require('./controllers/personDeviceController');
...
router.get('/person-device/:person_id/:device_id', getPersonDeviceById);
